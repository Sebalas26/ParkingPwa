...
1. **RBAC 100% Basado en Datos**:
   ...
   - El administrador del sistema tiene libertad absoluta de crear roles con cualquier nombre (*"Cajera Noche"*, *"Auxiliar Patio"*, *"Operario Caja"*, etc.). Los componentes deben evaluar únicamente los slugs de permisos (`authService.hasPermission('slug')`).
